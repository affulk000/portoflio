...
<template>
    ...
    >
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute top-1/3 right-1/4 w-[500px] h-[500px] rounded-full blur-3xl opacity-20 bg-orange-400 dark:bg-orange-500" style="animation: float 20s ease-in-out infinite" />
        </div>
